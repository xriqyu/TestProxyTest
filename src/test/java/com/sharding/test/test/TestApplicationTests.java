package com.sharding.test.test;

import com.sharding.DataRecord;
import com.sharding.SpringUtil;
import com.sharding.mapper.DataRecordMapper;
...
public class TestApplicationTests {
    ...
    public void testBlobData(){
        ...
        record.setUuid(UUID.randomUUID().toString().toLowerCase());
        ...
        record = mapper.selectByPrimaryKey(record.getUuid());
        mapper.delete(record.getUuid());
